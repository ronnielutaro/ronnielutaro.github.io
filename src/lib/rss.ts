...
export async function getRssXml() {
  ...
  const blogUrl = 'https://ronnielutalo.github.io/blog';
  ...
  return `
    <rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:blogChannel="${blogUrl}">
      <channel>
        <title>Ronnie Lutalo Blog</title>
        <link>${blogUrl}</link>
        <description>The Ronnie Lutalo Blog, thoughts, mental models, and tutorials about front-end development.</description>
