...
export default function Post({ post, related }: PostProps) {
  const seoTitle = `${post.title} | Ronnie Lutalo`;
  const seoDesc = `${post.summary}`;
  const url = `https://ronnielutalo.github.io/blog/${post.slug}`;
    ...
    <>
      <NextSeo
        ...
        openGraph={{
          ...
          images: [
            {
              url: post.og
                ? `https://ronnielutalo.github.io${post.og}`
          ...
          article: {
            ...
            authors: ["https://ronnielutalo.github.io"],
          },
        }}
      />
      ...
      <div className="flex flex-col gap-20">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-secondary">
            Get an email when I write new posts. 
            I write about software engineering, animation techniques, design systems and more
          </p>
          <NewsletterInput />
        </div>
