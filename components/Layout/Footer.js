                                    ...
                                    <div className="widget">
                                        <h5 className="m-b30 text-white">Subscribe To Newsletter</h5>
                                            <p className="text-capitalize m-b20">
                                                Subscribe to my newsletter and be the first to know whenever I release new content.
                                            </p>
                                        ...
                                        <ul className="list-inline m-a0">
                                            <a href={profile.socialLinks.Twitter} target="_blank" className="site-button twitter circle mr-1" rel="noreferrer"><i className="fa fa-twitter"></i></a>
                                            <a href={profile.socialLinks.LinkedIn} target="_blank" className="site-button linkedin circle mr-1" rel="noreferrer"><i className="fa fa-linkedin"></i></a>
                                            <a href={profile.socialLinks.GitHub} target="_blank" className="site-button github circle mr-1" rel="noreferrer"><i className="fa fa-github"></i></a>
                                            <a href={profile.socialLinks.Instagram} target="_blank" className="site-button instagram circle mr-1" rel="noreferrer"><i className="fa fa-instagram" rel="noreferrer"></i></a>
                                            <a href={profile.socialLinks.Facebook} target="_blank" className="site-button facebook circle mr-1" rel="noreferrer"><i className="fa fa-facebook" rel="noreferrer"></i></a>
                                        </ul>
                                    </div>
                                </div>
                            </div>
