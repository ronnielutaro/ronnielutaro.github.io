...
export default function Project({ project, rest }: ProjectProps) {
  const seoTitle = `${project.title} Case Study | Ronnie Lutalo`;
  const seoDesc = `${project.description}`;
  const url = `https://ronnielutalo.github.io/project/${project.slug}`;
      ...
      <div className="flex flex-col gap-20">
        <article>
          ...
          <div className="flex flex-col gap-3 px-4 md:px-6 py-2 max-w-[700px] mx-auto ">
            ...
            <h1 className="text-secondary">Category : Web Design</h1>
            {project.description}
          </div>
          <div className="h-12" />
